...
// Enter button for  Duration input

document.getElementById('duration').addEventListener('keyup',(e)=>{
  if (e.keyCode===13){
    if(parseFloat(document.getElementById('duration').value)<0){
      alert('You Must Enter Positive Value on Slider Change Duration')
